 ...
 */
app.controller('doubleRankingCtrl', function ($scope,$state,$http,$window) {
    ...
    $http({
        ...
        //跳转到认证级别
        $scope.toAuthenticationLevel = function () {
            $window.sessionStorage.category = 2
            $state.go('authenticationLevel')
        }
