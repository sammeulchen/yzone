 ...
 */
app.controller("singleRank1", function ($http,$scope,$window,$state) {
    ...
    $http({
        ...
        method:'get',
        params:{category:1,level:level,gender:gender}
        ...
        if(response.result== 0){
            ...
            $scope.loadMore = function () {
                ...
                $http({
                    url:SITE_SUFFIX+'api/ucenter/level/rank',
                    method:'get',
                    params:{category:1,page:$scope.page,level:level,score:score,gender:gender}
                }).success(function (response) {
                    console.log(response)
                    if(response.result== 0){
