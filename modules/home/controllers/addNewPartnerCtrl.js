 ...
 */
app.controller('addNewPartnerCtrl', function ($scope,$state,$stateParams,$http,$window,$ionicPopup,$rootScope) {
    ...
    $scope.oldPid = -1
    var location  = SITE_SUFFIX+'addNewPartner/'+$scope.competitionId
    $http({
